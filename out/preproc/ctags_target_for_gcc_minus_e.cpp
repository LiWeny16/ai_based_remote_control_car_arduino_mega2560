# 1 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino"
// @开源协议 GPL3.0
// @作者 Bigonion
// @NameSpace bigonion.cn
// @github https://github.com/LiWeny16/ai_based_remote_control_car_arduino_mega2560

# 7 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino" 2
// #include "Arduino.h"
...
void interrupt_sum_encoder_1() {
  sum_encoder(&count_1, 2 /*负责中断*/, 24 /* 判断正反*/);
}
void interrupt_sum_encoder_2() {
  sum_encoder(&count_2, 3, 25);
}
void interrupt_sum_encoder_3() {
  sum_encoder(&count_3, 18, 26);
}
void interrupt_sum_encoder_4() {
  sum_encoder(&count_4, 19, 27);
}
...
# 44 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino" 3
   (*(volatile uint8_t *)((0x1C) + 0x20)) 
# 44 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino"
        = 
# 44 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino" 3
          (1 << (4))
# 44 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino"
                    ; //清除MEGA 2560中断0请求标志位//引脚2
    
# 45 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino" 3
   (*(volatile uint8_t *)((0x1C) + 0x20)) 
# 45 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino"
        = 
# 45 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino" 3
          (1 << (5))
# 45 "C:\\Learning\\sample\\Arduino\\FYP\\Mega 2560\\main\\main.ino"
                    ; //清除MEGA 2560中断1请求标志位//引脚3
    attachInterrupt(((2 /*负责中断*/) == 2 ? 0 : ((2 /*负责中断*/) == 3 ? 1 : ((2 /*负责中断*/) >= 18 && (2 /*负责中断*/) <= 21 ? 23 - (2 /*负责中断*/) : -1))), interrupt_sum_encoder_1, 1);
    attachInterrupt(((3) == 2 ? 0 : ((3) == 3 ? 1 : ((3) >= 18 && (3) <= 21 ? 23 - (3) : -1))), interrupt_sum_encoder_2, 1); //当电平发生改变时触发中断函数
    attachInterrupt(((18) == 2 ? 0 : ((18) == 3 ? 1 : ((18) >= 18 && (18) <= 21 ? 23 - (18) : -1))), interrupt_sum_encoder_3, 1); //当电平发生改变时触发中断函数
    attachInterrupt(((19) == 2 ? 0 : ((19) == 3 ? 1 : ((19) >= 18 && (19) <= 21 ? 23 - (19) : -1))), interrupt_sum_encoder_4, 1); //当电平发生改变时触发中断函数
    delay(1000);
  }
}
